  ...
  body: `
    ...
    <div class="proj-cards">
      <div class="proj-card anim-up">
        ...
        <p>โปรเจกต์หรือรายงานที่รับผิดชอบดูแลและส่งกับทางมหาวิทยาลัย ถ้ามีเอกสารที่ต้องให้<br>พี่เลี้ยงและ HR เซ็น ให้ส่งล่วงหน้าอย่างน้อย 1 อาทิตย์ หรือ 5 วันทำการ</p>
      </div>
